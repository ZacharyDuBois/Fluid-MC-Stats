...
if(!file_exists('config.php')){
    ...
    $installLoc = $http . $_SERVER['HTTP_HOST'] . dirname($_SERVER["REQUEST_URI"]) . "/install/index.php";
...
<html>
<head>
    <title>Fluid MC Stats - Home</title>
...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#"><i class="fa fa-plus">
            <!-- TODO: Change fa-plus to $fa_icon from config.php -->

        </i> Fluid MC Stats</a> <!-- TODO: Change Fluid MC Stats to $site_name from config.php -->
    </div>
    <!-- /Mobile -->
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
            ...
            <li><a href="#"><i class="fa fa-bar-chart-o"></i> Top Players</a></li>
            <li><a href="#"><i class="fa fa-list"></i> Player List</a></li>
        </ul>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="jumbotron">
                        ...
                        <p>to the new Fluid MC Stats interface for your [server] powered by <a
                                href="http://developgravity.com/">Develop
                        ...
                        <div class="input-group input-group-lg">
                            ...
                            <span class="input-group-btn">
                                <button type="submit" class="btn btn-default">Find <i class="fa fa-chevron-right"></i>
                                </button>
                            </span>
                        </div>
                        <p>Explore...</p>
                        ...
                        <div class="list-group">
                            ...
                            <!-- TODO: Apply class active to li when page is current -->
                            <a href="pages/server-stats.html" class="list-group-item"><i class="fa fa-hdd-o"></i> Server
                                Stats</a>
                            <a href="#" class="list-group-item"><i class="fa fa-bar-chart-o"></i> Top Players</a>
                            <a href="#" class="list-group-item"><i class="fa fa-list"></i> Player List</a>
                        </div>
                        <div class="list-group">
    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="well well-sm">
                ...
                <p class="make-center">[Config defined text here] <i class="fa fa-info-circle"></i> Fluid MC Stats
                    v0.0.1 Pre-Alpha is &copy;
                    Copyright
                    <a href="http://developgravity.com/">Develop Gravity</a> and <a href="http://lolmewn.nl">Lolmewn</a>,
