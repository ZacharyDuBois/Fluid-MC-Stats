...
<html>
<head>
  <title>Fluid MC Stats - Player - Zachary DuBois</title>
  ...
  <div class="col-md-6 col-md-offset-1">
    <div class="panel panel-primary">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-user"></i> Player &dash; Zachary_DuBois</h3>
      </div>
      <div class="panel-body">
        ...
        <p class="make-center">
          <img src="http://mctar.polardrafting.com/Zachary_DuBois/400" class="img-rounded avatar-player-page">
        </p>
