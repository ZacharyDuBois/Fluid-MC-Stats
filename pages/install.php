          ...
          <div class="panel-body">
            ...
            if ($faultFound) {
              ...
              <div class="jumbotron">
                ...
                <a href="install.php"><button class="btn btn-primary">Reassess</button></a>
              </div>
              <?php
            } else {
              ...
              <div class="well well-lg">
                <form class="form-horizontal" role="form" autocomplete="off">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <div class="input-group">
                        <input type="text" class="form-control" id="mySQLHost" placeholder="Hostname">
                    ...
                    <div class="col-sm-2">
                      <input type="text" class="form-control" id="mySQLHostPort" placeholder="3306">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <div class="input-group">
                        <input type="text" class="form-control" id="mcResolveAddr" placeholder="play.example.com">
                        <span class="input-group-addon">&colon;</span>
                      </div>
                      <span class="help-block">
                    ...
                    <div class="col-sm-2">
                      <input type="text" class="form-control" id="mcResolveAddrPort" placeholder="25565">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="mcDispAddr" placeholder="play.example.com">
                      <span class="help-block">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="fmcsIcon" placeholder="plus">
                      </div>
                      <span class="help-block">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="fmcsFooterTxt" placeholder="Some random cool footer text &colon;)">
                      <span class="help-block">
                        Some text you want to include next to the footer text. Keep it short as it looks better when it doesn't need to wrap lines.
                      </span>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-3">
                      <input type="text" class="form-control" id="fmcsLink1Name" placeholder="Develop Gravity">
                    </div>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="fmcsLink1URL" placeholder="http&colon;//developgravity.com/">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-3">
                      <input type="text" class="form-control" id="fmcsLink2Name" placeholder="Lolmewn">
                    </div>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="fmcsLink2URL" placeholder="http&colon;//lolmewn.nl/">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-3">
                      <input type="text" class="form-control" id="fmcsLink3Name" placeholder="Mojang">
                    </div>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="fmcsLink3URL" placeholder="http&colon;//mojang.com/">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-3">
                      <input type="text" class="form-control" id="fmcsLink4Name" placeholder="Example 4">
                    </div>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="fmcsLink4URL" placeholder="http&colon;//example.com/">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-3">
                      <input type="text" class="form-control" id="fmcsLink5Name" placeholder="Example 5">
                    </div>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="fmcsLink5URL" placeholder="http&colon;//example.com/">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="fmcsAdvCDN" placeholder="http&colon;//static.example.com/">
                      <span class="help-block">
